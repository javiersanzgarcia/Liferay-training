...
public interface LibraryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.jsanz.library.service.impl.LibraryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the library local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LibraryLocalServiceUtil} if injection and service tracking are not available.
	 */
