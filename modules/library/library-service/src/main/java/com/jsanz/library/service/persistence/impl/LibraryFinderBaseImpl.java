 ...
 * @generated
 */
public abstract class LibraryFinderBaseImpl
	extends BasePersistenceImpl<Library> {

	public LibraryFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return libraryPersistence.getBadColumnNames();
	}
